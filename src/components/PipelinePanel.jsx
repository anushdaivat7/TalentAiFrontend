...
import {
  Database, ShieldCheck, Filter, Trophy, ChevronRight, ArrowUpRight, ArrowRight,
} from "lucide-react";
import ScoreBadge from "./ScoreBadge";

// Discovery funnel: how 100k candidates narrow down to the Top 100.
export default function PipelinePanel({ stats, topCandidates = [], onShowTrap, onShowTop10, onCandidateClick }) {
  ...
  return (
    <div className="card p-5">
      ...
      {topCandidates.length > 0 && (
        <div ref={topListRef} className="mt-5 pt-5 border-t border-slate-800 scroll-mt-20">
          <div className="flex items-center justify-between mb-3">
            <div>
              <h4 className="font-semibold text-slate-200">Top 10 Candidates</h4>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {topCandidates.map((r) => (
                  <tr
                    key={r.candidate_id}
                    onClick={() => onCandidateClick?.(r.candidate_id)}
