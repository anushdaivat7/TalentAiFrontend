...
import {
  generateSubmission, validateSubmission, downloadSubmission, downloadReportPdf,
} from "../api";
...
export default function SubmissionPanel() {
  ...
  const downloadPdf = async () => {
    setPdfBusy(true);
    try {
      await downloadReportPdf(team);
    } catch (e) {
      setStatus({ error: e?.response?.data?.detail || "PDF download failed" });
    } finally {
      setPdfBusy(false);
    }
  };
